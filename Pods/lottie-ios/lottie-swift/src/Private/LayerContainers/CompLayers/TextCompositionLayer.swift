...
final class TextCompositionLayer: CompositionLayer {
    ...
    let textStrokeLayer = DisabledTextLayer()
    ...
    init(textLayer: TextLayerModel, textProvider: AnimationTextProvider) {
        ...
        textStrokeLayer.masksToBounds = false
        self.textLayer.isWrapped = true
        textStrokeLayer.isWrapped = true
    }
    ...
    override func displayContentsWithFrame(frame: CGFloat, forceUpdates: Bool) {
        ...
        textStrokeLayer.contentsScale = renderScale
        ...
        let strokeAttributedString = NSAttributedString(string: textString, attributes: attributes)
